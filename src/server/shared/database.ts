...
const MIGRATIONS: Migration[] = [
  ...
  // docs/218 — the merged head whose continuation the user declined; the offer
  // is not made again for that merge.
  (db) => {
    addSessionColumnIfMissing(db, "merge_continue_declined_sha");
  },
];
