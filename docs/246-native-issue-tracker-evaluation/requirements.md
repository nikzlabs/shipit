...
- 2026-08-03 — Public ShipIt user bug reports remain in the public ShipIt GitHub repository, including reports created through the existing in-product bug-report flow. The private tracker requirement applies to the owner's planning issues, so the public and private trackers must coexist rather than one replacing the other.
