    ...
    async (request, reply: FastifyReply) => {
      ...
      try {
        ...
        return {
          ...
          stage2Ran: compiled.stage2Ran,
          message:
            "A redacted bug-report card has been posted in the chat. The user must review and confirm it before anything is sent — nothing has been filed yet. ShipIt will deliver their decision back to you (the issue number and URL on confirm, or a decline on cancel), so don't ask them how the card was resolved.",
        };
      } catch (err) {
