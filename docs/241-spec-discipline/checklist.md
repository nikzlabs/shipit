...
- [ ] Resolve the three open `[NEEDS CLARIFICATION]` markers in requirements.md (blocks everything below, per the discipline's own clarify gate)
- [ ] Validator library: parse opted-in `requirements.md`/`checklist.md`, extract IDs, produce findings (241-REQ-010..016)
