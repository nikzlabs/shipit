...
echo "  routes preview iframes through sslip.io — so previews work with NO tailnet"
echo "  policy grant (docs/216). Only the preview frames touch sslip.io; auth,"
echo "  terminal, and secrets do not."
echo ""
