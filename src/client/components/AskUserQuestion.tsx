      ...
      {needsSubmitButton && !isAnswered && (
        <div className="px-3 pb-3">
          <button
            ...
            className="px-4 py-1.5 rounded-md text-sm font-medium bg-blue-600 text-white hover:bg-blue-500 disabled:opacity-50 disabled:cursor-default transition-colors"
