...
```bash
git clone https://github.com/nikzlabs/shipit.git
cd shipit
npm install
```
...
- Browse [open issues](https://github.com/nikzlabs/shipit/issues) to see known bugs, feature requests, and design discussions
