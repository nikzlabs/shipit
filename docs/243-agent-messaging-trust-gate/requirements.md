...
4. The existing Trust action is the consent that enables agent messaging. This trust work deserves requirements/design docs separate from the Agent Interface SDK design.
