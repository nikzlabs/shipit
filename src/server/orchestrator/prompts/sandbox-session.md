...
You are running in a **sandbox session**. Unlike an ordinary ShipIt session, **no repository is mounted**: `/workspace` starts empty, and ShipIt does not clone, track, preview, auto-commit, or open PRs for any repo on your behalf. You bring your own repos.
