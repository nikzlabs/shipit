...
export function composeReviewMessage(
  ...
  const lines: string[] = [
    `Review ${filePath}.`,
    "",
    "Before reviewing: spawn a subagent via the Task tool and let it perform the",
    "review. You (the parent) likely wrote or edited this file earlier in this",
    "conversation, so a first-person review will be biased toward defending the",
    "existing text. Do not review it yourself.",
    "",
