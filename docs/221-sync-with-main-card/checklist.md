...
- [x] Card emitted for every manual sync (including already-current)
- [x] Card also emitted on the automatic conflict-resolve path wherever the branch was rewritten (2026-08-17 incident — that path left no durable record at all)
