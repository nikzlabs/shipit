...
# at runtime; egress-sidecar (shipit-egress-sidecar:dev) is the planning#92 egress firewall
# image — rebuilt here so a docker/egress-sidecar/ change actually ships to dev sessions
# instead of silently lagging a stale manual build (planning#92 verification finding).
