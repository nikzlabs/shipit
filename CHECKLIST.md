...
- [x] Conversation replay as system prompt when branching (clean context for new CLI session)
...
- [x] Timeline view in GitHistory area with checkpoint nodes and color-coded branches
