# Codex implied implementation intent — checklist

- [x] Record requirements and confirm there are no open questions
- [x] Trace shared and backend-specific instruction composition
