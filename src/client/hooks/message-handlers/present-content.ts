 ...
 * a new file, or refresh an existing one in place (the store keys on the
 * content-addressed `presentId`); the AppLayout right panel surfaces the
 * Present tab when the store gains its first entry.
 *
