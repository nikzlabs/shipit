...
function TemplateCard({
  ...
  return (
    <button
      ...
      disabled={disabled}
      className="flex items-start gap-3 p-3 rounded-lg border border-gray-700 bg-gray-800/50 hover:bg-gray-700/50 hover:border-gray-600 transition-colors text-left disabled:opacity-50 disabled:cursor-not-allowed"
    >
